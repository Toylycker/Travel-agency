            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <h1 class="text-2xl font-bold mb-6">Edit Room: {{ room.name }}</h1>
...
const form = useForm({
    _method: 'PUT', // Important for Laravel to recognize this as an update
    name: props.room.name,
    name_cn: props.room.name_cn,
    body: props.room.body,
    body_cn: props.room.body_cn,
    room_quan: props.room.room_quan,
    hotel_id: props.room.hotel_id,
    price: props.room.price,
    discount_percent: props.room.discount_percent,
    discount_datetime_start: props.room.discount_datetime_start ? props.room.discount_datetime_start.slice(0,19).replace('T', ' ') : null, // Format for Naive UI
    discount_datetime_end: props.room.discount_datetime_end ? props.room.discount_datetime_end.slice(0,19).replace('T', ' ') : null, // Format for Naive UI
});
